defmodule Refactoring.Cap01.FirstExample.Step21 do
  def start do
  ...
  def statement(invoice, plays) do
    statement_data = %{
      ...
      performances: invoice["performances"] |> Enum.map(&enrich_performance/1)
    }
  ...
  def enrich_performance(a_performance) do
    a_performance
  end
