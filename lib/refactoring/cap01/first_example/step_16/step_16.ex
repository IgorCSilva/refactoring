defmodule Refactoring.Cap01.FirstExample.Step16 do
  def start do
  ...
  def statement(invoice, plays) do
    ...
    total_amount = apple_sauce(invoice, plays)
    ...
    result = result <>
    """
    You earned $#{total_volume_credits(invoice, plays)} credits
    """

    result
  end

  def apple_sauce(invoice, plays) do
    total_amount = 0

    Enum.reduce(
      invoice["performances"],
      total_amount,
      fn perf, total_amount ->
